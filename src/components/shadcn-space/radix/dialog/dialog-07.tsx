...
import "@/components/shadcn-space/radix/dialog/dialog-07.css";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
export default function Dialog07({ children }: { children: React.ReactNode }) {
        ...
        <div className="flex flex-col items-center gap-4 px-8 py-6 text-center">
          <DialogHeader className="items-center gap-2">
            ...
            <DialogDescription className="text-base">
              Pick a future date from the calendar below to schedule your
              booking.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex w-full flex-col gap-3">
            ...
            {/* Confirm Book Button */}
            <Button
              className="w-full h-11 cursor-pointer rounded-full bg-teal-600 hover:bg-teal-700 text-white transition-colors"
              disabled={!date} // তারিখ সিলেক্ট না করা পর্যন্ত বাটন ডিজেবল থাকবে
